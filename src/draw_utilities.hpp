...
public:
    ...
    void drawRectangleWithTexture(WindowCoords coord, int w, int h, unsigned int textureID, Color color = {1.0f, 1.0f, 1.0f, 1.0f}, int angle = 0);
    void drawRectangleWithTexture(WindowCoordsRectangle coords, unsigned int textureID, Color color = {1.0f, 1.0f, 1.0f, 1.0f}, int angle = 0);
